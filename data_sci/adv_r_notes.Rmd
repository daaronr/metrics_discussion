...
metaprogramming capabilities allow you to write magically succinct
and concise functions and provides an excellent environment for designing domain-specific languages
...
(p27)
has aspects of both functional and object-oriented
(OO) programming languages

(p30)
 Output is commented
so that if you have an electronic version of the book, e.g., http://advr.had.co.nz, you can easily copy and paste examples into R
...
or strings, which you might think would be scalars, are actually vectors
of length one.

(p34)
factors, an important data
...
and FALSE becomes 0. This is very useful in conjunction with sum() and
mean()
x <- c(FALSE
