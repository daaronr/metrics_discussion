...
- The demographics (and psychographics, etc) of the movement,
...
To find ways to build membership (perhaps 'expand and diversify') and participation in the movement (including specific behaviors like donating),especially through...

- Funding causal drivers that 'work', and
