...
[Related question/post on ResearchGate here](https://www.researchgate.net/post/Measuring_composition_attitudes_of_rare_hidden_population_with_convenience_samples_river_sample_opt-in_G-based_what_to_do_read)
...
### Brainstorm: Bayesian inference/updating for estimating demographics and attitudes of an rare/hidden population
...
We have an opt-in web survey that has been administered yearly in years $t=0,...,T$.  (Skipping the zero index here for readability.)
...
Suppose there are the survey has only been run for 2 years. 
