...
'an estimate of the average of potentially heterog ests'
...
... Alternatively, extensive varn in the estd ATEs but each is precise... $\tau$ is likely to be relvly large.

*TODO: some code exercises should be put or linked here*
