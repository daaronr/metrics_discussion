...
The brms package has a way of running the model again once it has compiled, without compiling it agin. The following code increases the number of iterations from 2000 to 10000. Notice the difference in time it takes to run the code blocks.
...
<div class="marginnote">
Is  'assessing convergence' a subjective judgement?\*)@ScottDickinson1701 This seems helpful, but it seems like there should be some more objective methods.
