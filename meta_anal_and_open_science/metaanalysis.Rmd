...
30 iterations is no doubt far too few, but the run process is too slow to do many more here. 

I find it surprising how long this procedure takes to run, this simulation, given that the actual data used (estimates and SE's) is rather small.
