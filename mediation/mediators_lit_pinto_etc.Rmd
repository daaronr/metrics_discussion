...
In the "substitution between charities" context...
...
and the final outcome $Y$ is the amount given to other charities/ charities in the second round.
...
Thus we consult the relevant literature...
...
Cf charities in choice set, previous donation choices (?), previous choice sets, controlled nudges, observable demographics
</div>

\

2.  unobservable/unmeasured inputs (cf human capital, social connections\...; unobservable generosity, wealth, or temporary mood)
...
<div class="marginnote">
Cf the impact of having made the first donation on later donations; what else?
</div>
